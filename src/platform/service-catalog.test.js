...
test("bacnet.read is attributed to the bacnet-core service and its consumers", () => {
  ...
  assert.deepEqual(consumerIds, ["alarm-console", "bacnet-historian", "bacnet-manager", "building-alerts", "building-devices", "building-rules", "building-workspace", "device-graphics"]);
